...
def manager_page():
    ...
    context['article_list'] = Advert.query.order_by(desc(Advert.date_created)).all()

    return render_template('manager_page.html', context=context, active_tab='timeline')



@app.route('/article/detail/<int:id>', methods=['GET'])
def article_detail(id):
    article = Advert.query.get(id)
    return render_template("home.html")
